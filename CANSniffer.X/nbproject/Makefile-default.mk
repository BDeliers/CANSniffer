...
SOURCEFILES_QUOTED_IF_SPACED=usb/usb_descriptors.c usb/usb_events.c usb/src/usb_device.c usb/src/usb_device_cdc.c main.c app_device_cdc.c config.c spi/spi.c mcp2515/MCP2515.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/usb/usb_descriptors.p1 ${OBJECTDIR}/usb/usb_events.p1 ${OBJECTDIR}/usb/src/usb_device.p1 ${OBJECTDIR}/usb/src/usb_device_cdc.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/app_device_cdc.p1 ${OBJECTDIR}/config.p1 ${OBJECTDIR}/spi/spi.p1 ${OBJECTDIR}/mcp2515/MCP2515.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/usb/usb_descriptors.p1.d ${OBJECTDIR}/usb/usb_events.p1.d ${OBJECTDIR}/usb/src/usb_device.p1.d ${OBJECTDIR}/usb/src/usb_device_cdc.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/app_device_cdc.p1.d ${OBJECTDIR}/config.p1.d ${OBJECTDIR}/spi/spi.p1.d ${OBJECTDIR}/mcp2515/MCP2515.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/usb/usb_descriptors.p1 ${OBJECTDIR}/usb/usb_events.p1 ${OBJECTDIR}/usb/src/usb_device.p1 ${OBJECTDIR}/usb/src/usb_device_cdc.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/app_device_cdc.p1 ${OBJECTDIR}/config.p1 ${OBJECTDIR}/spi/spi.p1 ${OBJECTDIR}/mcp2515/MCP2515.p1

# Source Files
SOURCEFILES=usb/usb_descriptors.c usb/usb_events.c usb/src/usb_device.c usb/src/usb_device_cdc.c main.c app_device_cdc.c config.c spi/spi.c mcp2515/MCP2515.c
...
${OBJECTDIR}/mcp2515/MCP2515.p1: mcp2515/MCP2515.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/mcp2515" 
	@${RM} ${OBJECTDIR}/mcp2515/MCP2515.p1.d 
	@${RM} ${OBJECTDIR}/mcp2515/MCP2515.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -I"usb" -I"usb/inc" -I"usb/src" -I"." -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/mcp2515/MCP2515.p1 mcp2515/MCP2515.c 
	@-${MV} ${OBJECTDIR}/mcp2515/MCP2515.d ${OBJECTDIR}/mcp2515/MCP2515.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mcp2515/MCP2515.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
