...
v2.00       2021/02/15  Added functions to manage the chip over SPI

Copyright 2003 Kimberly Otten Software Consulting
Copyright 2021 Balthazar DELIERS
...
/*   CAN PAYLOAD   */
// Structure to handle MCP2515 data, cf datasheet page 30
typedef struct {
    uint16_t stdId;
    uint24_t extId;
...
/*     INSTRUCTIONS FUNCTIONS, cf. datasheet P65     */

// Initialize SPI and resets chip
